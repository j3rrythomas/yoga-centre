...
import heroSrc from "./../../assets/images/hero-img.jpg";
      ...
      <div className="container-sm">
        <div className={innerClasses}>
          <div className="hero-content">
            ...
            >
              Yoga{" "}
              <span className="text-color-primary" style={{ fontSize: "2rem" }}>
                noun
              </span>
            </h1>
            <div className="container-xs">
              ...
              <div className="reveal-from-bottom" data-reveal-delay="600">
                <ButtonGroup>
                  <Button tag="a" color="primary" wideMobile href="/classes">
                  ...
                  <Button
                    ...
                    wideMobile
                    rel="canonical"
                    href="https://www.healthline.com/nutrition/13-benefits-of-yoga"
                    target="_blank"
                  >
                    Why Yoga?
                  </Button>
